 ...
 */
var PHASER_PATH = './node_modules/phaser/build/custom/';
...
function copyPhaser() {
    ...
    var srcList = ['phaser-no-physics.min.js'];
    
    if (!isProduction()) {
        srcList.push('phaser-no-physics.map', 'phaser-no-physics.js');
    }
...
/**
 * Copies required Assets files from the './src/assets/' folder into the './build/assets' folder.
 */
 function copyAssets() {
...
gulp.task('copyAssets', ['copyPhaser'], copyAssets);
